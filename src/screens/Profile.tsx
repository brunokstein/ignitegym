...
export function Profile() {
        ...
        try {
            ...
            if (photoSelected.assets[0].uri) {
                ...
                if (photoInfo.size && (photoInfo.size / 1024 / 1024 > 3)) {
                    return toast.show({
                        title: 'Essa imagem e muito grande. Escolha uma de ate 3MB.',
                        placement: 'top',
                        bgColor: 'red.500'
                    });
                }
    ...
    async function handleProfileUpdate(data: FormDataProps) {
        try {
            ...
            const title = isAppError ? error.message : 'Nao foi possivel atualizar os dados. Tente novamente mais tarde.';
